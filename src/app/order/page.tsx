...
import { CartProduct } from "../cart/page";
...
export default function Order() {
    ...
    const { products, total } = JSON.parse(params) as { products: CartProduct[], total: number }
    const formatedTotal = (total / 100).toLocaleString("it-IT", {
        style: 'currency',
        currency: 'EUR'
    })
